...
const Home = () => {
  ...
  const processSteps = [
    {
      ...
      color: "primary",
      image:
        "https://images.unsplash.com/photo-1592891056565-d035c022bfdb?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      step: "2",
      ...
      color: "warning",
      image:
        "https://images.unsplash.com/photo-1643792801605-1f8081811439?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8Y2FyJTIwa2V5c3xlbnwwfHwwfHx8MA%3D%3D",
    },
    {
      step: "3",
      title: "Hit the Road",
      ...
      color: "success",
      image:
        "https://images.unsplash.com/photo-1536825591064-574efec257f2?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
  ];
          ...
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-12 col-lg-6 mb-4 mb-lg-0">
                ...
                <h2 className="display-6 fw-bold text-gradient mb-3">
                  HK SELF DRIVE CARS <br />
                  <span className="fw-medium fs-5">Your drive – our pride</span>
                </h2>
                <p className="text-muted lead mb-3">
                  Hyderabad’s Biggest Self-Drive Car Services operating across
                  key areas:
                  <strong> Vanasthalipuram</strong>, <strong>Boduppal</strong>,
                  and <strong>Dilsukhnagar</strong>.
                </p>
                <div className="badge bg-white text-dark shadow-sm px-3 py-2 rounded-pill">
                  100+ Cars • 50K+ Customers • Since 2019
                </div>
              </div>
  ...
  <div className="container">
    <div className="text-center mb-5">
      ...
      <h2 className="fw-bold mb-3" style={{ fontSize: "2.75rem", color: "#212529" }}>
        Explore Our Premium Offerings
      </h2>
      <p className="lead text-muted mx-auto" style={{ maxWidth: "700px" }}>
        Choose from our flexible and reliable self-drive rental services in Hyderabad. Transparent pricing and a wide range of vehicles await you.
      </p>
    </div>
      ...
      {services.map((service, index) => (
          ...
          >
            <div
              ...
              style={{
                ...
                height: "80px",
                borderRadius: "50%",
                background: `var(--${service.color}-color, #0d6efd)`,
                color: "#fff",
                fontSize: "2rem",
              }}
            >
            ...
            <p className="text-muted mb-4" style={{ fontSize: "0.95rem", minHeight: "60px" }}>
              {service.description}
            </p>
            ...
            <div className="text-start">
              {service.features.map((feature, idx) => (
                <div key={idx} className="d-flex align-items-start mb-2">
                  <CheckCircle size={16} className={`text-${service.color} me-2 mt-1`} />
            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6 mb-5 mb-lg-0">
                ...
                <p className="lead text-muted mb-4">
                  Discover the freedom of driving on your own terms with HK
                  Self-Drive Cars – proudly serving Hyderabad since 2019.
                  Whether you need a car for a quick day trip, weekend getaway,
                  or business travel, we offer hassle-free rentals tailored to
                  your schedule.
                </p>
                ...
                <ul className="list-unstyled">
                  <li className="mb-3 d-flex">
                    ...
                    <span className="text-muted">
                      Wide fleet of well-maintained cars — hatchbacks, sedans &
                      SUVs
                    </span>
                  </li>
                  <li className="mb-3 d-flex">
                  ...
                  <li className="mb-3 d-flex">
                    <CheckCircle size={20} className="text-success me-2 mt-1" />
                    <span className="text-muted">
                      Serving all key localities including Vanasthalipuram,
                      Boduppal & Dilsukhnagar
                    </span>
                  </li>
                </ul>
        ...
        >
          <div className="container position-relative text-white">
            <div
              className=" row align-items-center  shadow-lg rounded-4"
              style={{
            ...
            >
              <div className=" col-lg-8 p-4 ">
                ...
                <p className="lead mb-4" style={{ opacity: 0.9 }}>
                  ...
                  rentals. Enjoy 24/7 customer care, doorstep delivery, and
                  bookings made easy—just with your license and ID.
                </p>
          ...
          <div className="container">
            <div className="text-center mb-5">
              ...
              <p
                ...
                style={{ maxWidth: "600px" }}
              >
                We’re available in multiple cities! Find the nearest store and
                book your ride in person.
              </p>
            </div>
              ...
              <div className="col-md-4">
                <div className="card h-100 shadow-sm border-0">
                  <div className="card-body">
                    ...
                    <p className="card-text text-muted">
                      Near Vanasthalipuram Police Station, Hyderabad, Telangana
                      - 500070
                    </p>
                    <p className="mb-1">
                      <Phone size={14} className="me-2" />
              ...
              <div className="col-md-4">
                <div className="card h-100 shadow-sm border-0">
                  <div className="card-body">
                    ...
                    <p className="card-text text-muted">
                      Opp. Metro Station, Dilsukhnagar, Hyderabad, Telangana -
                      500036
                    </p>
                    <p className="mb-1">
                      <Phone size={14} className="me-2" />
